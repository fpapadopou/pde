...
class DefaultSettingsCommand extends ContainerAwareCommand
{
    ...
    {
        // Use the command like 'php app/console pde:settings:set'
        $this->setName('pde:settings:set');
        ...
        // Running 'php app/console pde:settings:set --help' will display this message
